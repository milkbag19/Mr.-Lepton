...
exports.getCard = exports.getCardBySetCodeAndCollectorNumber = exports.getCollection = exports.random = exports.autocomplete = exports.getCardNamed = exports.search = exports.getCards = void 0;
...
function getCards(page) {
    ...
    return api_request_1.get("/cards", {
        page: String(page),
    });
}
